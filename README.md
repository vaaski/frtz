...
_See code: [src/commands/config/profiles.js](https://github.com/vaaski/frtz/blob/v0.4.3/src/commands/config/profiles.js)_
...
_See code: [src/commands/config/show.js](https://github.com/vaaski/frtz/blob/v0.4.3/src/commands/config/show.js)_
...
_See code: [src/commands/devices/list.js](https://github.com/vaaski/frtz/blob/v0.4.3/src/commands/devices/list.js)_
...
_See code: [src/commands/devices/wake.js](https://github.com/vaaski/frtz/blob/v0.4.3/src/commands/devices/wake.js)_
...
_See code: [src/commands/setup.js](https://github.com/vaaski/frtz/blob/v0.4.3/src/commands/setup.js)_
<!-- commandsstop -->
